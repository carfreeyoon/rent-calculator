...
st.markdown(f"""
    <div class="common-info-box">
        ...
        <table class="common-table">
            <thead><tr><th style="width: 35%;">차량명</th><th style="width: 25%;">옵션</th><th style="width: 16%;">차량가격</th><th style="width: 12%;">계약기간</th><th style="width: 12%;">약정거리</th></tr></thead>
            <tbody><tr><td class="font-bold" style="text-align:left; padding-left:10px;">{car_name}</td><td style="color:gray;">{car_option}</td><td class="font-bold" style="color:#0b3873;">{car_price:,} 원</td><td>{months} 개월</td><td>{mileage}</td></tr></tbody>
        </table>
    </div>
""", unsafe_allow_html=True)
...
h = lambda m, k: "td-highlight" if str(months) == m and k in mileage else ""
with m_col1:
    ...
    <tr><td>2만KM</td><td class="{h('24','2만')}">72%</td><td class="{h('36','2만')}">64%</td><td class="{h('48','2만')}">57%</td><td class="{h('60','2만')}">50%</td></tr></table>""", unsafe_allow_html=True)

with m_col2:
    st.markdown("**■ 신용별 할부이자**")
    st.markdown("""<table class="matrix-table"><tr><th>구분</th><th>할부이자</th></tr><tr><td>500점 이하</td><td>10.5 ~ 14.9%</td></tr><tr><td>900점 이상</td><td>3.5 ~ 4.8%</td></tr></table>""", unsafe_allow_html=True)

c = lambda val: "td-highlight" if val in cc_text or (val == "전기차" and "전기" in car_shape) else ""
with m_col3:
    st.markdown("**■ 자동차세 (연간)**")
    st.markdown(f"""<table class="matrix-table"><tr><th>구분</th><th>연간 비용</th></tr>
    <tr><td class="{c('1000')}">1000CC 이하</td><td>₩ 104,000</td></tr>
    <tr><td class="{c('1600')}">1600CC 이하</td><td>₩ 291,200</td></tr>
...
with m_col4:
    ...
    st.markdown(f"""<table class="matrix-table"><tr><th>구분</th><th>세율/감면</th></tr>
    <tr><td class="{t('경차')}">경차(4%)</td></tr>
    <tr><td class="{t('전기')}">전기차(7%)</td></tr>
    <tr><td class="{t('하이브리드')}">하이브리드(7%)</td></tr></table>""", unsafe_allow_html=True)
