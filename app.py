...
st.markdown("""
    ...
    /* 2. 메인 비교 테이블 (공백 버그 유발하던 기존 capture-box 구조 전면 수정) */
    ...
    .compare-container { border: 2px solid #0b3873; border-radius: 6px; background-color: #ffffff; padding: 15px; }
...
# ==========================================
# [📊 MAIN VISUAL] 대칭형 비교 테이블 (공백 박스 제거 버전)
# ==========================================
