...
# [BACKEND] 연산 로직
e15, e14 = ("O" if "승합" in car_shape else ""), ("O" if "경차" in car_shape else "")
g14, i14 = ("O" if "전기" in car_shape or "수소" in car_shape else ""), ("O" if "하이브리드" in car_shape else "")
...
st.markdown(f"""
    <div class="common-info-box">
        ...
        <table class="common-table">
            ...
            <tbody><tr><td class="font-bold">{car_name}</td><td>{car_option}</td><td class="font-bold" style="color:#0b3873;">{car_price:,} 원</td><td>{months} 개월</td><td>{mileage}</td></tr></tbody>
        </table>
    </div>
""", unsafe_allow_html=True)
...
with view_col1:
    ...
    <table class="pure-table">
        ...
        <tr><td class="font-bold">총 할부 이자</td><td>{total_inst_interest:,} 원</td><td rowspan="4" class="bg-light text-blue" style="vertical-align:middle;">월 렌트료에<br>전부 포함</td></tr>
        <tr><td class="font-bold">취등록세</td><td>{reg_tax:,} 원</td></tr>
    ...
    """, unsafe_allow_html=True)
    if diff_ret > 0: st.markdown(f'<div class="excel-green">🏆 장기렌트 선택 시 할부 대비 {diff_ret:,}원 절감!</div>', unsafe_allow_html=True)
...
with view_col2:
    ...
    <table class="pure-table">
        ...
        <tr><td class="font-bold">선납금</td><td>{installment_prepaid:,} 원</td><td>{rent_deposit:,} 원</td></tr>
        <tr><td class="font-bold">월납입금</td><td>{inst_monthly_pay:,} 원</td><td>{rent_monthly_pay:,} 원</td></tr>
        <tr><td class="font-bold">총 할부 이자</td><td>{total_inst_interest:,} 원</td><td rowspan="6" class="bg-light text-blue" style="vertical-align:middle;">월 렌트료에<br>전부 포함</td></tr>
        <tr><td class="font-bold">취등록세</td><td>{reg_tax:,} 원</td></tr>
        <tr><td class="font-bold">자동차세</td><td>{total_tax:,} 원</td></tr>
        <tr><td class="font-bold">보험료</td><td>{total_ins:,} 원</td></tr>
    ...
    """, unsafe_allow_html=True)
    if diff_ins > 0: st.markdown(f'<div class="excel-green">🏆 장기렌트 선택 시 할부 대비 {diff_ins:,}원 절감!</div>', unsafe_allow_html=True)
