...
# 추가된 변수: 할부 만기 매각율
installment_resale_pct = st.sidebar.number_input("📉 할부 만기 매각율 (%)", value=residual_rent_pct, min_value=0, max_value=100, step=1)
...
# [변경점] 할부 차량 매각액 계산에 residual_sell_pct 대신 installment_resale_pct 적용
