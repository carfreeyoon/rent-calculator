...
st.markdown("""
    ...
    .td-highlight { background-color: #fff3bf; font-weight: bold; }
...
with m_col3:
    st.markdown("**■ 자동차세 (연간)**")
    st.markdown("""<table class="matrix-table"><tr><th>구분</th><th>비용</th></tr><tr><td>1000CC 이하</td><td>₩ 104,000</td></tr><tr><td>1600CC 이하</td><td>₩ 291,200</td></tr><tr><td>2000CC 이하</td><td>₩ 520,000</td></tr><tr><td>2500CC 이하</td><td>₩ 650,000</td></tr><tr><td>3000CC 초과</td><td>₩ 780,000</td></tr><tr><td>전기차</td><td>₩ 130,000</td></tr></table>""", unsafe_allow_html=True)
with m_col4:
