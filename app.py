...
# 연산 로직
e15 = "O" if "승합" in car_shape else ""; e14 = "O" if "경차" in car_shape else ""; g14 = "O" if "전기" in car_shape or "수소" in car_shape else ""; i14 = "O" if "하이브리드" in car_shape else ""
...
res_matrix = {"1만Km": {24: 78, 36: 70, 48: 63, 60: 56}, "1.5만Km": {24: 75, 36: 67, 48: 60, 60: 53}, "2만Km": {24: 72, 36: 64, 48: 57, 60: 50}, "3만Km": {24: 65, 36: 55, 48: 48, 60: 40}}
residual_sell_pct = res_matrix.get(mileage, res_matrix["2만Km"]).get(months, 50)
loan_amount = car_price - installment_prepaid; r = (installment_rate / 100) / 12
...
rent_takeover_price = int(car_price * (residual_rent_pct / 100)); rent_takeover_tax = int(rent_takeover_price * 0.07)
