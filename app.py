...
with view_col1:
    ...
    <table class="pure-table">
        ...
        <tr><td class="font-bold">총 할부 이자</td><td>{total_inst_interest:,} 원</td><td rowspan="5" class="bg-light text-blue" style="vertical-align:middle;">월 렌트료에<br>전부 포함</td></tr>
    ...
    """, unsafe_allow_html=True)
    st.markdown(f'<div class="{"excel-green" if diff > 0 else "excel-red"}">{"🏆 장기렌트 선택 시 할부 대비 " + str(diff) + "원 절감!" if diff > 0 else "할부 이용이 유리합니다."}</div>', unsafe_allow_html=True)
...
with view_col2:
    ...
    <table class="pure-table">
        ...
        <tr><td class="font-bold">선납금</td><td>{installment_prepaid:,} 원</td><td>{rent_deposit:,} 원</td></tr>
        <tr><td class="font-bold">월납입금</td><td>{inst_monthly_pay:,} 원</td><td>{rent_monthly_pay:,} 원</td></tr>
        <tr><td class="font-bold">총 할부 이자</td><td>{total_inst_interest:,} 원</td><td rowspan="7" class="bg-light text-blue" style="vertical-align:middle;">월 렌트료에<br>전부 포함</td></tr>
        <tr><td class="font-bold">취등록세</td><td>{reg_tax:,} 원</td></tr>
        <tr><td class="font-bold">자동차세</td><td>{total_tax:,} 원</td></tr>
        <tr><td class="font-bold">보험료</td><td>{total_ins:,} 원</td></tr>
