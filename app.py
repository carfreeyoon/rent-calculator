...
with m_col3:
    st.markdown("**■ 자동차세 (연간)**")
    st.markdown('<table class="matrix-table"><tr><th>구분</th><th>연간 비용</th></tr><tr><td>1600CC이하</td><td>₩291,200</td></tr><tr><td>2000CC이하</td><td>₩520,000</td></tr></table>', unsafe_allow_html=True)
with m_col4:
    st.markdown("**■ 취등록세 감면율**")
    st.markdown('<table class="matrix-table"><tr><th>구분</th><th>세율</th></tr><tr><td>하이브리드</td><td>7%</td></tr><tr><td>전기차</td><td>7%</td></tr></table>', unsafe_allow_html=True)
