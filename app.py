...
def get_tax(price, shape):
    ...
    if e15 and g14: reg_tax_raw = (price * 0.05) - 1400000
    elif e15 and i14: reg_tax_raw = (price * 0.05) - 400000
    elif e15: reg_tax_raw = price * 0.05
    elif e14: reg_tax_raw = (price * 0.04) - 750000
    elif g14: reg_tax_raw = (price * 0.07) - 1400000
    elif i14: reg_tax_raw = (price * 0.07) - 400000
    else: reg_tax_raw = price * 0.07
    return max(0, int(reg_tax_raw))
...
# [수정된 로직] 잔존가치 기준 인수 가격 및 동일 감면 로직 적용
