...
# [BACKEND] 연산 로직 (할부 매각액 수식 부분만 수정)
...
# [수정] 할부 차량 매각액 계산에 입력받은 installment_resale_pct 적용
