...
rent_resale_pct = 58       # 렌트 고정 잔존가치(58%)
...
installment_prepaid = st.sidebar.number_input("💵 할부 선납금", value=0, step=1000000) # 기본값 0 변경
...
avg_monthly_interest = int(total_inst_interest / months)
...
with view_col1:
    ...
    <table class="pure-table">
        ...
        <tr><td class="font-bold">할부 이자(월)</td><td>{avg_monthly_interest:,} 원</td><td rowspan="4" class="bg-light text-blue" style="vertical-align:middle;">월 렌트료에<br>전부 포함</td></tr>
